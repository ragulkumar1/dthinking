    ...
    <footer className="bg-gray-900 text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          {/* School Info */}
          <div>
            <h3 className="text-lg font-semibold">CBSE School</h3>
            <p className="mt-4 text-sm text-gray-300">
              Providing quality education and holistic development for students since 1990.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-300">
              ...
              <li>Email: info@cbseschool.com</li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-sm text-gray-300">
          <p>&copy; {new Date().getFullYear()} CBSE School. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
