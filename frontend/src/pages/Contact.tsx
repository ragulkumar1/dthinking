...
const contactInfo = [
  {
    title: 'Address',
    content: '123 School Street, City, State 12345',
    icon: (
...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - CBSE School</title>
        <meta name="description" content="Get in touch with CBSE School. Find our contact information, location, and send us a message." />
      </Helmet>
            ...
            {contactInfo.map((info) => (
              <div key={info.title} className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">{info.content}</p>
                </div>
              </div>
            ))}
          </div>
